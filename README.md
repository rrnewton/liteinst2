...
a W^X arena prepared before signal-driven registration. Exact one-byte rapid
...
patch word, mapping-lifecycle ownership, and a trap fallback when the planner
returns `PunPlan::TrapRequired`.
